...
import com.neo.duan.ui.adapter.base.base.animation.AlphaInAnimation;
import com.neo.duan.ui.adapter.base.base.animation.BaseAnimation;
import com.neo.duan.ui.adapter.base.base.animation.ScaleInAnimation;
import com.neo.duan.ui.adapter.base.base.animation.SlideInBottomAnimation;
import com.neo.duan.ui.adapter.base.base.animation.SlideInLeftAnimation;
import com.neo.duan.ui.adapter.base.base.animation.SlideInRightAnimation;
import com.neo.duan.ui.adapter.base.base.entity.IExpandable;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case LOADING_VIEW:
                ...
                break;
           case HEADER_VIEW:
                baseViewHolder = new XBaseViewHolder(mHeaderLayout);
                break;
            case EMPTY_VIEW:
                baseViewHolder = new XBaseViewHolder(mEmptyView == mCopyEmptyLayout ? mCopyEmptyLayout : mEmptyView);
                break;
            case FOOTER_VIEW:
                baseViewHolder = new XBaseViewHolder(mFooterLayout);
                break;
            default:
    ...
    private BaseViewHolder getLoadingView(ViewGroup parent) {
        ...
        return new XBaseViewHolder(mLoadingView);
    }
    ...
    protected BaseViewHolder createBaseViewHolder(ViewGroup parent, int layoutResId) {
        if (mContentView == null) {
            return new XBaseViewHolder(getItemView(layoutResId, parent));
        }
        return new XBaseViewHolder(mContentView);
    }
