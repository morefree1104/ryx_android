...
import com.neo.duan.ui.widget.photoview.PhotoView;
...
public class SmoothImageView extends PhotoView {
    ...
    protected void initSmoothImageView() {
...
//		setBackgroundColor(mBgColor);
    ...
    public void setOriginalInfo(int width, int height, int locationX, int locationY) {
        ...
        mOriginalLocationY = mOriginalLocationY - DeviceUtils.getStatusBarHeight(getContext());
    }
    ...
    private void initTransform() {
        ...
        if (getDrawable() instanceof RootDrawable) return;
