...
public class JSONUtils {
     ...
     * @return <ul>
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData  exception, return defaultValue</li>
     *         </ul>
     */
    ...
    public static Map<String, String> parseKeyAndValueToMap(JSONObject sourceObj) {
        ...
        for (Iterator iter = sourceObj.entrySet().iterator(); iter.hasNext();) {
     ...
     *         <li>if source {@link JSONObject#( String )} exception, return null</li>
